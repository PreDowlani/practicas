...
localizar = personal.filter(function(loca) {
...
cambiarSt = personal.find(function(cambiar) {
...
sueldo = personal.some(function(money) {
    return money.salario === 12000
})

console.log(sueldo)

informe = personal.filter(function(list) {
...
//option 1
modificar = informe.filter(function(edit) { //son los dos programadores junior del ejercico anterior
...
// programadorJunior = personal.filter(function(junior){
//     return junior.puesto.includes('Junior')
// })
// console.log(programadorJunior)

// editar = programadorJunior.forEach(function(modif) {
//     modif.salario = 14000
// })
...
activos = personal.every(function(active) {
    return active.activo === true;
})

console.log(activos)

bajaDepresion = personal.find(function(bajaDep) {
...
proyecto = personal.filter(function(proj) {
...
asignar = personal.filter(function(add) {
    return add.puesto.includes('Junior') || add.puesto.includes('Senior')
})

console.log(asignar)

NewProyecto = asignar.forEach(function(newpr) {
...
eliminar =  personal.find(function(eli) {
...
desactivar = nuevoPersonal.map(function(desact) {
